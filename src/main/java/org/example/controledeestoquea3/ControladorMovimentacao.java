...
public class ControladorMovimentacao extends ControladorNavegacaoSuperior {
    ...
    public void abrirRelatorio() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/example/controledeestoquea3/RelatorioMovimentacoe.fxml"));
